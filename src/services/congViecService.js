 ...
 */
async function layCongViecTheoId(maCongViec, maNguoiDung) {
...
async function taoCongViec(maNguoiDung, duLieuCongViec) {
  ...
  return await congViecModel.taoCongViec({
    ...
    notification_times: duLieuCongViec.notification_times || [],
  });
}
...
async function capNhatCongViec(maCongViec, maNguoiDung, duLieuCongViec) {
  ...
  if (
    duLieuCongViec.status === "completed" &&
    congViecCu.status !== "completed"
  ) {
...
async function capNhatTrangThaiCongViec(maCongViec, maNguoiDung, trangThai) {
  ...
  const thoiDiemHoanThanh =
    trangThai === "completed" ? new Date().toISOString() : null;
